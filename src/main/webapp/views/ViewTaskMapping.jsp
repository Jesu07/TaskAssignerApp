	...
	<body id="page-top">
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				var user = $('#hello');
				var varurl = "https://ec2-54-247-71-245.eu-west-1.compute.amazonaws.com:5432/api/getAllUsers";
				$.ajax({
					type: 'GET',
					url: varurl,
					async: true,
				...
				$('#hello').change(function(){
	                $(this).find("option:selected").each(function(){
                		...
                		var pre = "https://ec2-54-247-71-245.eu-west-1.compute.amazonaws.com:5432/api/getAllTaskByUserId/";
                		var varurl = pre+id;
                		$.ajax({
                			type: 'GET',
                    		url: varurl,
