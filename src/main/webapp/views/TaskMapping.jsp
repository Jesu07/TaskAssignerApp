	...
	<body id="page-top" class="ubuntu">
		...
		<script type="text/javascript">
			$(document).ready(function(){
	            ...
	            $.ajax({
	                type:'GET',
	                url:"https://ec2-54-247-71-245.eu-west-1.compute.amazonaws.com:5432/api/getAllTask",
	                async:true,
	            ...
	            $.ajax({
	                type:'GET',
	                url:"https://ec2-54-247-71-245.eu-west-1.compute.amazonaws.com:5432/api/getAllUsers",
	                async:true,
	                success:function(result){
	                    var output = "<option selected disabled> -- Select -- </option>";
	                    for(var i in result){
